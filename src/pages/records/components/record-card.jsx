...
const RecordCard = ({ record, onNavigate, onDelete }) => {
  return (
    <div className="relative flex flex-col rounded-xl border bg-white shadow-sm dark:border-neutral-800 dark:bg-[#13131a]">
